...
public class OwnCompanyWrapperTests
{
    ...
    public async Task TestGetAllAvailable()
    {
        ...
        await AddMixedCompaniesAsync();
        await GetOwnCompanyAvailableAsync(3);
    }
    ...
    private async Task AddMixedCompaniesAsync()
    {
        ...
        var ownCompanyToAdd = new OwnCompanyAddRequestDto
        {
            Name = "Dotnetstore",
        ...
        await _testHelperService.Business.OwnCompany.Wrapper.AddAsync(ownCompanyToAdd);

        ownCompanyToAdd = new OwnCompanyAddRequestDto
        {
            Name = "Dotnetstore",
            Description = "My own company",
            CorporateID = "710520-1433"
    ...
    private async Task GetOwnCompanyAsync(int expectedQuantity)
    {
        ...
        var list = await _testHelperService.Business.OwnCompany.Wrapper.GetAllAsync();

        Assert.That(list, Is.Not.Null);
        Assert.That(list, Is.InstanceOf<List<OwnCompanyDto>>());
    ...
    private async Task GetOwnCompanyAvailableAsync(int expectedQuantity)
    {
        ...
        var list = await _testHelperService.Business.OwnCompany.Wrapper.GetAllAvailableAsync();
    ...
    private async Task GetOwnCompanyDeletedAsync(int expectedQuantity)
    {
        ...
        var list = await _testHelperService.Business.OwnCompany.Wrapper.GetAllDeletedAsync();
