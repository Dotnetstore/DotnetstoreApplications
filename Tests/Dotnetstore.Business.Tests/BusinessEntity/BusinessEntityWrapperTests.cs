...
public class BusinessEntityWrapperTests
{
    ...
    private async Task AddBusinessEntityAsync()
    {
        ...
        await _testHelperService.Business.BusinessEntity.Wrapper.AddAsync(null);
    }
    ...
    private async Task GetBusinessEntityAsync(int expectedQuantity)
    {
        ...
        var list = await _testHelperService.Business.BusinessEntity.Wrapper.GetAllAsync();
